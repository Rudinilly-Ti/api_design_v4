/*
  ...
  - You are about to drop the column `pruductId` on the `Update` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Update" DROP CONSTRAINT "Update_pruductId_fkey";

-- AlterTable
ALTER TABLE "Update" DROP COLUMN "pruductId",
