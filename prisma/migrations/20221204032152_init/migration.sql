...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_pruductId_fkey" FOREIGN KEY ("pruductId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
